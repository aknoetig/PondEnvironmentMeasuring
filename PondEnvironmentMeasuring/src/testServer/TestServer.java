   ...
   public static void main(String argv[]) throws Exception
      {
	     ...
	     String cvsContent = "02,00,00,02,07,2013,17,13,100\n" //2 o'clock
	    		 		   + "05,00,00,02,07,2013,17,12,500\n" //5 o'clock
	    		 		   + "08,00,00,02,07,2013,16,17,10000\n" //8 o'clock
	    		 		   + "11,00,00,02,07,2013,17,22,70000\n" //11 o'clock
	    		 		   + "14,00,00,02,07,2013,17,25,60000\n" //14 o'clock
